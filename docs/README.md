...
- `docs/training_profiles.md` - supported models, generated files, media requirements, and output roots
...
- Training references were refreshed for profile selection, managed runs, dataset/train TOML, three-character output prefixes, and config reset behavior.
