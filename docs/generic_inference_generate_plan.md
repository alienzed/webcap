...
5. **Explicit Take deletion:** implemented on `feature/storyboard-delete-take`, pending validation/merge. Reversible Remove/Restore stays separate from permanently confirmed Delete Take.
