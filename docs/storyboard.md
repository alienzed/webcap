...
- `expand_concept` turns a terse Story seed into a richer persistent overview without creating Scenes; the original user-authored concept is retained as the single restore point, and another expansion requires restoring that original first;
