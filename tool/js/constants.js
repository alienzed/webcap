...
ui = {
  ...
  advancedFilterPruneCandidatesEl: document.getElementById('advanced-filter-prune-candidates'),
  ...
  captionSheetBtn: document.getElementById('caption-sheet-btn'),
  pruneCandidatesBtn: document.getElementById('prune-candidates-btn'),
