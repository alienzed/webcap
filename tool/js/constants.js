...
state = {
  ...
  duplicateCandidatesFolder: '',
  duplicateCandidatesScopeKey: '',
  duplicateCandidatesScopeFiles: [],
  duplicateCandidatesStatus: 'idle',
  duplicateCandidatesError: '',
  duplicateCandidatesPopulation: 0,
  duplicateCandidatesSeq: 0,
  duplicateCandidatesDirty: false,
  duplicateCandidatesParentFocusSet: undefined,
  trainingCommand: '',
...
ui = {
  ...
  duplicateCandidatesPane: document.getElementById('duplicate-candidates-pane'),
  duplicateCandidatesListEl: document.getElementById('duplicate-candidates-list'),
  duplicateCandidatesSummaryEl: document.getElementById('duplicate-candidates-summary'),
  ...
  appSettingsStoryboardMaxTokensEl: document.getElementById('app-settings-storyboard-max-tokens'),
  ...
  appSettingsTrainingTestCopyHiRootEl: document.getElementById('app-settings-training-test-copy-hi-root'),
  appSettingsTrainingTestCopyLoRootEl: document.getElementById('app-settings-training-test-copy-lo-root'),
  appSettingsTrainingTestCopySubfolderEl: document.getElementById('app-settings-training-test-copy-subfolder'),
...
const MAPPINGS_SYSTEM_DEFAULTS = {
  requirements: {
    ...
    keywordsByItem: {
      ...
      "Clothing": "anklet, armband, armlet, bare shoulders, boots, bracelet, bracelets, camisole, choker, dress, earring, earrings, hat, high-heels, jacket, necklace, pants, ring, rings, shirt, shoes, shorts, skirt, sneakers, socks, suit, swimsuit, tiara, tie, topless, uniform",
