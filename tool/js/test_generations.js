(function () {
  ...
  function buildUi() {
    ...
    node.innerHTML = [
      ...
      '<label class="training-run-option"><span>Resolution (MP)</span><input id="test-generations-megapixels" type="number" min="0.2" step="0.1"></label>',
      '<label class="training-run-option"><span>Duration (seconds)</span><input id="test-generations-duration" type="number" min="3" step="1"></label>',
