...
function getTrainingWorkspaceEls() {
  return {
    ...
    launchStatus: document.getElementById('training-launch-status'),
    launchStatusCopy: document.getElementById('training-launch-status-copy'),
    launchStatusGlobalBtn: document.getElementById('training-launch-status-global-btn'),
    ...
    tensorboardLink: document.getElementById('training-tensorboard-link'),
