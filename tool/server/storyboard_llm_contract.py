...
def build_request(story, scene_id, operation, instruction=""):
    ...
    if operation == "develop_story":
        ...
        blocks.append(
            ...
            "Before writing Scenes, establish sharedContext for recurring subjects, wardrobe states, locations, and other persistent visible/audible facts. These definitions must be concrete, visually detailed, self-contained, and reusable verbatim. If the Story leaves a recurring person or place visually underspecified, choose one sensible concrete production design now and keep that exact definition stable. "
            "The definition itself must carry the identity: never substitute relative phrases such as 'the same woman', 'the same room', 'unchanged', or 'as before' for the actual observable description. Subjects should carry stable physical appearance; wardrobes should carry actual garments/colors/materials; locations should carry stable layout/materials/colors/fixed features/baseline practical lighting. "
